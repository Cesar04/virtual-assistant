...
@Injectable()
export class AgentSecGestionHumanaService {
  private _name: string = 'AgentSecGestionHumana';
  private _toolName: string = 'ToolSecGestionHumana';
  private _prompt: string = process.env.agentPromptGestionHumana;
  ...
  constructor(
    ...
    @Inject('TOOL_SEC_GESTION_HUMANA')
  ...
  private shouldContinue({ messages }: typeof MessagesAnnotation.State) {
    ...
    console.log('3. shouldContinue gestion ', this._toolName);
